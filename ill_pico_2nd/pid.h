...
class pid{
    float h,b_h,b_l,c,K_h,K_l,Ti,Tt,Td,y_old,I,D,N;
    float curr_b, curr_K, curr_r{0}, G{0};
  ...
  public:
    float r_h{10}, r_l{2};
  public:
    explicit pid(float h_, float b_h = 1, float b_l = 1, float c_ = 0, float K_h = 1, float K_l = 1, float Ti_ = 1, float Tt_ = 0.8, float Td_ = 1, float N_ = 10);
    ~pid(){};
