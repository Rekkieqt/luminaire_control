...
void ring_buffer::print_buff(bool raw) {
    if (raw) {
        for (int j = 0 ; j < BUFFER ; j++) {
            ...
            Serial.print("time :"); Serial.println(data_print->time);
    }
}
    else {
        for (int j = 0 ; j < BUFFER ; j++) {
            ...
            Serial.print(data_print->ref);Serial.print(" "); 
            Serial.print(data_print->time);Serial.println(" "); 
    }
}
}
